    ...
    with tlx.async_tasks():
        ...
        with tlx.async_task("default"):
            ...
            for tile_id in range(pid_0, mul_9, nprog_0):
                ...
                tlx.async_descriptor_store(c_desc, c_smem[0], [mul_14, mul_15])
        ...
        with tlx.async_task(num_warps=1, num_regs=24):
            ...
            for tile_id in range(pid_0, mul_9, nprog_0):
                ...
                for k in range(0, div_8, 1):
                    ...
                    # load → L0_smem_0
                    tlx.async_descriptor_load(a_desc, L0_smem_0[buf], [((tile_id // div_6) * 128), (k * 64)], L0_smem_0_full[(_it % 2)])
                    smem_accum += 1
        ...
        with tlx.async_task(num_warps=1, num_regs=24):
            ...
            for tile_id in range(pid_0, mul_9, nprog_0):
                ...
                for k in range(0, div_8, 1):
                    ...
                    # load → L0_smem_1
                    tlx.async_descriptor_load(b_desc, L0_smem_1[buf], [((tile_id % div_6) * 128), (k * 64)], L0_smem_1_full[(_it % 2)])
                    smem_accum += 1
