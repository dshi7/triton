    ...
    with tlx.async_tasks():
        ...
        with tlx.async_task("default"):
            ...
            for tile_id in range(pid_0, mul_13, nprog_0):
                ...
                div_16 = (tile_id // div_12)
                rem_17 = (tile_id % div_12)
                mul_18 = (div_16 * 128)
                mul_19 = (rem_17 * 128)
                ...
                trunc_0_20 = acc_0.to(tl.float16)
                tlx.async_descriptor_store_wait(1)
                tlx.local_store(c_smem[0], trunc_0_20)
                tlx.fence_async_shared()
                tlx.async_descriptor_store(c_desc, c_smem[0], [mul_18, (mul_19 + 0)], eviction_policy="evict_first")
                acc_sub_1 = tlx.subslice(acc_tmem[tmem_buf], 32, 32)
                acc_1 = tlx.local_load(acc_sub_1)
                trunc_1_21 = acc_1.to(tl.float16)
                tlx.async_descriptor_store_wait(1)
                tlx.local_store(c_smem[1], trunc_1_21)
                tlx.fence_async_shared()
                tlx.async_descriptor_store(c_desc, c_smem[1], [mul_18, (mul_19 + 32)], eviction_policy="evict_first")
                acc_sub_2 = tlx.subslice(acc_tmem[tmem_buf], 64, 32)
                acc_2 = tlx.local_load(acc_sub_2)
                trunc_2_22 = acc_2.to(tl.float16)
                tlx.async_descriptor_store_wait(1)
                tlx.local_store(c_smem[0], trunc_2_22)
                tlx.fence_async_shared()
                tlx.async_descriptor_store(c_desc, c_smem[0], [mul_18, (mul_19 + 64)], eviction_policy="evict_first")
                acc_sub_3 = tlx.subslice(acc_tmem[tmem_buf], 96, 32)
                acc_3 = tlx.local_load(acc_sub_3)
                tlx.barrier_arrive(acc_tmem_empty[tmem_buf], 1)
                trunc_3_23 = acc_3.to(tl.float16)
                tlx.async_descriptor_store_wait(1)
                tlx.local_store(c_smem[1], trunc_3_23)
                tlx.fence_async_shared()
                tlx.async_descriptor_store(c_desc, c_smem[1], [mul_18, (mul_19 + 96)], eviction_policy="evict_first")
                tmem_accum_cnt += 1
        ...
        with tlx.async_task(num_warps=1, num_regs=24):
            ...
            for tile_id in range(pid_0, mul_13, nprog_0):
                ...
                for k in range(0, div_15, 1):
                    ...
                    tlx.async_descriptor_load(a_desc, L0_smem_0[buf], [((tile_id // div_12) * 128), (k * 64)], L0_smem_0_full[buf])
                    smem_accum += 1
        ...
        with tlx.async_task(num_warps=1, num_regs=24):
            ...
            for tile_id in range(pid_0, mul_13, nprog_0):
                ...
                for k in range(0, div_15, 1):
                    ...
                    tlx.async_descriptor_load(b_desc, L0_smem_1[buf], [(k * 64), ((tile_id % div_12) * 128)], L0_smem_1_full[buf])
                    smem_accum += 1
